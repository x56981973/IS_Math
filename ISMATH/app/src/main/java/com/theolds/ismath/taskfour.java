        ...
        btnListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(view == calcBtn){
                    ...
                    for(int k = 0; k<256; k++){
                        int kl = k/16;
                        if(((Integer.bitCount(k & i) + Integer.bitCount(Integer.parseInt(dataMap[kl][k-kl*16],16) & j))%2) == 0) count++;
                    ...
                    for(int i = 1; i<256; i++){
                        for(int j = 1; j<256; j++){
                            ...
                            for(int k = 0; k<256; k++){
                                int kl = k/16;
                                if(((Integer.bitCount(k & i) + Integer.bitCount(Integer.parseInt(dataMap[kl][k-kl*16],16) & j))%2) == 0) count++;
                                //if( i ==1 && j == 72 && k == 1)Log.i("test", Integer.bitCount(kl & i) + " " + Integer.parseInt(dataMap[kl][k-kl*16],16)+" "+ Integer.bitCount(Integer.parseInt(dataMap[kl][k-kl*16],16) & j));
                            }
